...
class PaymentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('checkout_group')
            ->maxLength('checkout_group', 36)
            ->allowEmptyString('checkout_group');

        $validator
            ->scalar('stripe_session_id')
            ->maxLength('stripe_session_id', 255)
            ->allowEmptyString('stripe_session_id');
