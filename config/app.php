...
return [
    ...
    'App' => [
        ...
        // Set APP_BASE when the site is not at the server URL root (e.g. /team112-app_fit3047).
        // Leave unset for normal setups where the document root is webroot/.
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => env('EMAIL_FROM', 'noreply@candlecraft.com'),
    ...
    /*
     * OpenAI (optional). Used by TeacherAvailability assistant on the home page.
     * Set OPENAI_API_KEY in app_local.php or the environment; if unset, replies use local text only.
     */
    'OpenAI' => [
